...
v0_lead = max(min(v0_lead, v0_ego+20/3.6), v0_ego-20/3.6);
...
if rand() < prob_levh
    x0_lead = max(min(t_gap*v0_ego+D_default+25*randn(),120),15);
else
    x0_lead = 120 + (1000-120)*rand();
end
...
set_param('e2eDRL_ACC/Gain', 'Gain',mat2str(acceleration));
% set_param('Expert_data/Gain', 'Gain',mat2str(acceleration));
